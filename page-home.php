...
<section class="home-section-1 container" id="home">
    <div class="inner-home animatedParent animateOnce">
...
<section class="home-section-2 container">
<span id="about" class="anchor"></span>
    <div class="row animatedParent animateOnce">
        ...
        <div class="col-md-5 second-col animated slower fadeIn delay-250">
            <span><img src="wp-content/themes/mateusz/assets/avatar.png" alt="" class="img-fluid"></span>
        </div>
    </div>
</section>

<section class="home-section-3 container">
    <span id="skills" class="anchor"></span>
    <h1>Umiejętności</h1>
    <div class="row animatedParent animateOnce">
        <div class="col-md-5 first-col animated slower fadeIn delay-250">
        ...
        <div class="col-md-7 second-col animated slower fadeIn">
            <p>Jako Front-End Developer, mam opanowanego HTMLa oraz CSSa, których znajomość oceniam na bardzo dobrą. W projektach wykorzystuję również preprocesor CSS - SCSS. Aktualnie wciąż uczę się JavaScriptu, a jego znajomość oceniam na ponad przeciętną. W swojej pracy wykorzystuję również doświadczenia UXa, dzięki czemu nie mam problemu z operowaniem na wszelkiego rodzaju programach graficznych, głównie firmy Adobe.</p>
        </div>
    </div>
</section>

<section class="home-section-4 container">
...
<section class="home-section-5 container">
